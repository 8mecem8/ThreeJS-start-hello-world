...
const envoirementTexture = cubeTextureLoader.load([
...
material.envMap = envoirementTexture
...
gui.add(material, 'metalness').min(0.5).max(2).step(0.0001)
gui.add(material, 'roughness').min(0).max(2).step(0.0001)
gui.add(material, 'aoMapIntensity').min(0.5).max(8).step(0.00001)
gui.add(material, 'displacementScale').min(0.05).max(2).step(0.00001)
